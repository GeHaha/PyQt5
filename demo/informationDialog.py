# -*- coding: utf-8 -*-
"""
Created on Sat Sep 29 16:32:49 2018
...
class Example(QWidget):
    ...
    def question(self):
        reply = QMessageBox.question(self,'询问','这是一个询问消息对话框，默认No',QMessageBox.Yes|QMessageBox.No | QMessageBox.Cancel, QMessageBox.No)
